...
action = tf.multinomial(probabilities, num_samples=1) # Action is a tensor....

y = 1.0 - tf.to_float(action) # ...therefore tf.to_float
...
def helper_discount_rewards(rewards, discount_rate): # Calculates discout rewards
    '''
...
with tf.Session() as sess:
    ...
    for iteration in range(num_iterations):
        ...
        meta_graph_def = tf.train.export_meta_graph(filename='/models/my-pole-model.meta')
        saver.save(sess, '/models/my-pole-model')
